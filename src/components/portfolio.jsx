...
import stock2 from "../img/login3.jpg";
                      ...
                      <div className="col-sm-8">
                        ...
                        <div className="w-more">
                          <span className="w-ctegory">
                            HTML5 SCSS Bootstrap Angular 8 C#
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        ...
                        <div className="w-more">
                          <span className="w-ctegory">Sistema de Información; Angular 7 NodeJs</span>
                        </div>
                      </div>
                      <div className="col-sm-4">
                        <div className="w-like">
